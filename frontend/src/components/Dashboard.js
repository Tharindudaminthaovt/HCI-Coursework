      ...
      <div className="main-content">
        ...
        <div className="dashboard-content">
          ...
          <p>
            ...
            commodi animi obcaecati expedita quia eum officia, quas esse omnis
            repellendus nisi corrupti incidunt labore amet! Perspiciatis
            expedita quidem voluptates.
          </p>
          ...
          <div className="card-container">
            <div className="dashboard-card">
              ...
              <a href="/admin/create-room-design">
